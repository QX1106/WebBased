...
if (is_post()) {
    ...
    if ($email == '') {
        ...
        $_err['email'] = 'Maximum 50 characters';
    ...
    if ($password == '') {
        ...
        $_err['password'] = 'Maximum 50 characters';
...
<form method="post" enctype="multipart/form-data" novalidate>
    ...
    <?= err('email') ?>
    <?= html_text('email', "maxlength='50' data-check-available='email' placeholder='you@example.com'") ?>

    <label for="password">Password</label>
    <?= err('password') ?>
    <div class="pw-field">
        <?= html_password('password', "maxlength='50' placeholder='Enter password'") ?>
    ...
    <?= err('confirm') ?>
    <div class="pw-field">
        <?= html_password('confirm', "maxlength='50' placeholder='Re-enter your password'") ?>
