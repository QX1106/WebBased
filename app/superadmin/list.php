...
<p style="color:var(--muted); max-width:480px;">Create, search, and manage Admin accounts. Super Admin accounts never appear here.</p>
...
<table class="table">
    ...
    <?php if (!$arr): ?>
    <tr><td colspan="6">No admins match your search. <a href="/superadmin/admins/list.php">Clear filters</a> or <a href="/superadmin/admins/create.php">create a new admin</a>.</td></tr>
    <?php endif; ?>
</table>
